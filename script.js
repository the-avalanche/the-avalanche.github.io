...
//        lastName = nameArray[1]
        ...
        var justice = [
            ...
            {
                name: "Justice for Elijah McClain",
                dateAdded: "Added 06/25/20",
                desc: "Demanding accountability for the death of Elijah McClain, who was found hanging outside a library in Victorville and has thus far been dismissed as a suicide",
                subject: "Justice for Elijah McClain",
                number: "3038709078",
                body: `Hello,\n\nMy name is ${name}. I am a resident of ${area} and I am emailing today to demand accountability for the racist murder of Elijah McClain. I demand that charges be pressed against those involved in this heinous killing: Officers Nathan Woodward, Jason Rosenblatt, Randy Roedema, Matthew Green, and Sgt Dale Leonard as well as Lt. Peter Chichuniec and Medic Jeremy Cooper of Aurora Fire Rescue. They should all be fired, charged, and prosecuted for their crimes. Elijah McClain was wrongly detained for simply walking down the street. An unethical "carotid hold" was performed during his detainment which led to his death. The body cams of all three officers also were not used or working correctly during the altercation. Elijah was 23 years old at the time of his death. He was an energetic and friendly massage therapist, working to relieve people of their pain and offer relaxation during times of stress. He should be alive today. He would be alive today if it were not for the gross abuse of power and white supremacy exhibited by the Aurora Police Department. All officers involved must face consequences for this murder in order to provide his family with justice and to deter law enforcement from committing racist and brutal acts of violence against communities of color. In addition, I demand that we provide more support for community efforts and organizations that work to prevent police brutality and violence.\n\nSincerely,\n${name}`,
...
//            },
        ...
        for (var i = 0; i < removals.length; i++) {
            ...
            var paragraph = ""
            if (source["number"] == "") {
                paragraph = `<div class="col-md-4 mb-5" ><div class="card h-100"><div class="card-body"><h4 class="card-title">${source["name"]}</h4><h6 class="card-subtitle mb-2 text-muted">${source["dateAdded"]}</h6><p class="card-text">${source["desc"]}</p></div><div class="card-footer"><a href="${link}" target="_" class="btn btn-primary">Send Email</a></div></div></div>`
            } else {
                paragraph = `<div class="col-md-4 mb-5" ><div class="card h-100"><div class="card-body"><h4 class="card-title">${source["name"]}</h4><h6 class="card-subtitle mb-2 text-muted">${source["dateAdded"]}</h6><p class="card-text">${source["desc"]}</p></div><div class="card-footer"><a href="${link}" target="_" class="btn btn-primary">Send Email</a><a href="tel:${source["number"]}" class="btn btn-primary">Make a Call</a></div></div></div>`
            }
